...
Energi digital, presisi dan tegas. Daya untuk harimu.
...
Logo, banner, nama tampilan, metadata, font dan warna memakai identitas DayaKlik.
...
Alamat lokal: http://localhost:3101
...
Konfigurasikan pulsa-be/.env berdasarkan .env.example. Gunakan database dayaklik
dan akun H2HR yang ditetapkan untuk aplikasi ini. Jalankan migrasi sesuai dokumentasi
proyek asal, lalu jalankan go run . dari pulsa-be. Port backend: 8101.
...
lalu arahkan service khusus dayaklik ke release tersebut.
