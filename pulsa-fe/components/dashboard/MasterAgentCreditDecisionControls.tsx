...
function ReviewSignaturePad({
  ...
  return (
    <div className="rounded-[24px] border border-emerald-300 bg-[linear-gradient(180deg,#ffffff_0%,#f3fff9_100%)] p-4 text-center shadow-[0_12px_26px_rgba(4,120,87,0.10)]">
      ...
      <p className={hasInk ? "mt-1 text-[9px] font-black text-[#185adb]" : "mt-1 text-[9px] font-black text-slate-400"}>
            ...
            {!statusEditorOpen ? (
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <button type="button" onClick={() => void changeCreditOperationalStatus()} disabled={statusBusy} className="inline-flex h-10 items-center justify-center gap-2 rounded-xl bg-[#12316b] text-[10px] font-black text-white disabled:opacity-60">
