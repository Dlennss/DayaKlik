  ...
  return (
    <section className="space-y-3 pb-28">
      ...
      >
        ...
        <span className="grid h-10 w-10 place-items-center rounded-2xl border border-white/70 bg-lime-300 text-[#12316b] shadow-[0_8px_18px_rgba(163,230,53,0.28)] transition group-hover:translate-x-0.5">
