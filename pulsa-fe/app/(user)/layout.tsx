...
export default async function UserLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-svh bg-sky-50 text-neutral-900 md:grid md:place-items-start md:py-4">
      <div className="relative mx-auto w-full max-w-[390px] md:border md:border-slate-200 md:bg-sky-50 md:shadow-[0_24px_80px_rgba(15,23,42,0.18)]">
        <AppTopHeader
