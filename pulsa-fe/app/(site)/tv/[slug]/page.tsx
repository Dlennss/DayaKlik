...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!brand) {
    return buildPageMetadata({
      title: "TV Berlangganan | DayaKlik",
      description: "Beli paket atau bayar layanan TV berlangganan di DayaKlik.",
      path: "/tv",
    });
  }

  return buildPageMetadata({
    title: `${brand.nama} | TV Berlangganan DayaKlik`,
    description: `Beli paket atau bayar layanan ${brand.nama} di DayaKlik dengan proses yang ringkas.`,
    path: `/tv/${slug}`,
