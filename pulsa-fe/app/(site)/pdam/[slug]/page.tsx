...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!brand) {
    return buildPageMetadata({
      title: "Tagihan PDAM | DayaKlik",
      description: "Cek dan bayar tagihan PDAM di DayaKlik.",
      path: "/pdam",
    });
  }

  return buildPageMetadata({
    title: `${brand.nama} | Tagihan PDAM DayaKlik`,
    description: `Cek dan bayar tagihan ${brand.nama} di DayaKlik dengan proses cepat dan ringkas.`,
    path: `/pdam/${slug}`,
