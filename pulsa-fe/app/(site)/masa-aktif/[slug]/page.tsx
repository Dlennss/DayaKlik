...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!brand) {
    return buildPageMetadata({
      title: "Masa Aktif Semua Operator | DayaKlik",
      description: "Perpanjang masa aktif nomor Anda di DayaKlik.",
      path: "/masa-aktif",
    });
  }
  ...
  return buildPageMetadata({
    title: `Perpanjang Masa Aktif ${brandTitle} | DayaKlik`,
    description: lowestPrice
      ? `Perpanjang masa aktif ${brandTitle} di DayaKlik. Produk aktif tersedia mulai Rp ${lowestPrice.toLocaleString("id-ID")}.`
      : `Perpanjang masa aktif ${brandTitle} di DayaKlik dengan pilihan produk yang jelas.`,
...
export default async function MasaAktifBrandPage({ params }: PageProps) {
  ...
  const collectionJsonLd = buildCollectionJsonLd({
    title: `Perpanjang Masa Aktif ${brandTitle} | DayaKlik`,
    description: `Perpanjang masa aktif ${brandTitle} di DayaKlik dengan pilihan produk yang jelas.`,
    path: `/masa-aktif/${slug}`,
  ...
  const faqJsonLd = buildFaqJsonLd([
    {
      question: `Apakah masa aktif ${brandTitle} di DayaKlik tersedia dalam beberapa pilihan?`,
      answer: `Ya. DayaKlik menampilkan produk masa aktif ${brandTitle} yang aktif agar pembeli bisa memilih sesuai kebutuhan.`,
    },
    {
      question: `Bagaimana cara memperpanjang masa aktif ${brandTitle} di DayaKlik?`,
    ...
    },
    {
      ...
      answer: `Bisa. Halaman ini bisa dipakai pembeli umum maupun member DayaKlik untuk kebutuhan pribadi dan penjualan ulang.`,
    },
  ]);
