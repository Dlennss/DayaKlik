...
export const metadata: Metadata = buildPageMetadata({
  title: "Pulsa Semua Operator | DayaKlik",
  description: "Isi pulsa Telkomsel, Indosat, XL, Axis, Smartfren, dan operator lain di DayaKlik dengan pilihan nominal yang jelas dan transaksi cepat.",
  path: "/pulsa",
