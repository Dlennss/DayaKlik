...
const pageTitle = "Privacy Policy DayaKlik | Website and Android App";
const pageDescription =
  "Privacy policy for DayaKlik website and Android application, including account data, transactions, security, and Google sign-in usage.";
