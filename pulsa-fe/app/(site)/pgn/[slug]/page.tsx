...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!brand) {
    return buildPageMetadata({
      title: "Tagihan PGN | DayaKlik",
      description: "Cek dan bayar tagihan gas PGN di DayaKlik.",
      path: "/pgn",
    });
  }

  return buildPageMetadata({
    title: `${brand.nama} | Tagihan PGN DayaKlik`,
    description: `Cek dan bayar tagihan ${brand.nama} di DayaKlik dengan proses yang ringkas.`,
    path: `/pgn/${slug}`,
