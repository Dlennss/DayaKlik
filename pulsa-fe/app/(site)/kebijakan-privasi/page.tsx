...
const pageTitle = "Syarat & Ketentuan DayaKlik | Layanan Produk Digital";
const pageDescription =
  "Syarat dan ketentuan penggunaan DayaKlik untuk transaksi produk digital, saldo, agent, marketing, dan kredit agent.";
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Syarat dan Ketentuan DayaKlik",
      },
    ],
  },
  twitter: {
