...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (universalService) {
    return buildPageMetadata({
      title: `${universalService === "esim-roaming" ? "eSIM & Roaming" : "HP Pascabayar"} | DayaKlik`,
      description: "Layanan digital DayaKlik.",
      path: `/kategori/${id}`,
    });
  }
  ...
  if (!category) {
    return buildPageMetadata({
      title: "Kategori Produk | DayaKlik",
      description: "Lihat kategori produk DayaKlik.",
      path: "/kategori",
    });
  }

  return buildPageMetadata({
    title: `${category.nama} | DayaKlik`,
    description: `Lihat pilihan brand dan produk ${category.nama} di DayaKlik.`,
    path: `/kategori/${id}`,
...
export default async function GuestKategoriPage({ params }: PageProps) {
  ...
  const collectionJsonLd = buildCollectionJsonLd({
    title: `${categoryName} | DayaKlik`,
    description: `Lihat pilihan brand dan produk ${categoryName} di DayaKlik.`,
    path: `/kategori/${id}`,
