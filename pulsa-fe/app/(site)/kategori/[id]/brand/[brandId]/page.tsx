...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return buildPageMetadata({
    title: `${brand} | ${categoryName} DayaKlik`,
    description: `Lihat produk ${brand} pada kategori ${categoryName} di DayaKlik.`,
...
export default async function GuestBrandProductsPage({ params }: PageProps) {
  ...
  const collectionJsonLd = buildCollectionJsonLd({
    title: `${brand} | ${categoryName || "Produk"} DayaKlik`,
    description: `Lihat produk ${brand} pada kategori ${categoryName || "produk"} di DayaKlik.`,
    path: `/kategori/${id}/brand/${brandId}`,
