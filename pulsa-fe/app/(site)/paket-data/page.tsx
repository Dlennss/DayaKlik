...
export const metadata: Metadata = buildPageMetadata({
  title: "Paket Data Semua Operator | DayaKlik",
  description: "Beli paket data harian, mingguan, dan bulanan semua operator di DayaKlik dengan pilihan grup produk yang lebih jelas.",
  path: "/paket-data",
