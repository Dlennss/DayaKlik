...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!brand) {
    return buildPageMetadata({
      title: "Aktivasi Perdana | DayaKlik",
      description: "Pilih produk aktivasi perdana operator di DayaKlik.",
  ...
  return buildPageMetadata({
    title: `Aktivasi Perdana ${brandTitle} | DayaKlik`,
    description: lowestPrice
      ? `Pilih produk aktivasi perdana ${brandTitle} di DayaKlik. Produk aktif tersedia mulai Rp ${lowestPrice.toLocaleString("id-ID")}.`
      : `Pilih produk aktivasi perdana ${brandTitle} di DayaKlik dengan pilihan yang jelas.`,
...
export default async function AktivasiPerdanaBrandPage({ params }: PageProps) {
  ...
  const collectionJsonLd = buildCollectionJsonLd({
    title: `Aktivasi Perdana ${brandTitle} | DayaKlik`,
    description: `Pilih produk aktivasi perdana ${brandTitle} di DayaKlik dengan pilihan yang jelas.`,
    path: `/aktivasi-perdana/${slug}`,
  ...
  const faqJsonLd = buildFaqJsonLd([
    {
      question: `Apakah produk aktivasi perdana ${brandTitle} di DayaKlik tersedia lengkap?`,
      answer: `Ya. DayaKlik menampilkan produk aktivasi perdana ${brandTitle} yang aktif agar pembeli bisa memilih sesuai kebutuhan.`,
    },
    {
      question: `Bagaimana cara membeli aktivasi perdana ${brandTitle} di DayaKlik?`,
    ...
    },
    {
      ...
      answer: `Bisa. Halaman ini dapat dipakai pembeli umum maupun member DayaKlik untuk transaksi pribadi dan penjualan ulang.`,
    },
  ]);
