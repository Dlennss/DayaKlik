...
export const metadata: Metadata = buildPageMetadata({
  title: "Produk Listrik PLN | DayaKlik",
  description: "Pilih token listrik atau pembayaran tagihan listrik PLN di DayaKlik.",
  path: "/listrik",
...
export default async function GuestListrikPage() {
  ...
  const cards = [
    {
      ...
      href: "/listrik/token",
      icon: Zap,
      accent: "from-lime-300 via-emerald-500 to-[#12316b]",
    },
    {
      key: "tagihan",
      ...
      icon: FileText,
      accent: "from-yellow-300 via-green-500 to-[#12316b]",
    },
  ];
  ...
  return (
    <main className="min-h-screen bg-[#f1f5fc]">
      ...
      <div className="space-y-4 px-4 pt-4 pb-28">
        {!listrikCategory ? (
          ...
          <>
            <section className="relative overflow-hidden rounded-[30px] bg-[#12316b] p-4 text-white shadow-[0_22px_48px_rgba(5,46,38,0.26)]">
              ...
              <div className="relative flex items-center gap-3">
                ...
                <div className="min-w-0">
                  <p className="text-[10px] font-black uppercase tracking-[0.18em] text-lime-200">DayaKlik PLN</p>
              ...
              return (
                ...
                >
                  ...
                  <div className="relative flex items-center gap-3">
                    ...
                    <span className="grid h-9 w-9 shrink-0 place-items-center rounded-full bg-lime-100 text-[#12316b] transition group-hover:translate-x-0.5 group-hover:bg-lime-300">
