...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!brand) {
    return buildPageMetadata({
      title: "Internet Pascabayar | DayaKlik",
      description: "Cek dan bayar tagihan internet pascabayar di DayaKlik.",
      path: "/internet-pascabayar",
    });
  }

  return buildPageMetadata({
    title: `${toTitleCase(brand.nama)} | Internet Pascabayar DayaKlik`,
    description: `Cek dan bayar tagihan ${toTitleCase(brand.nama)} di DayaKlik dengan proses yang ringkas.`,
...
export default async function InternetPascabayarSlugPage({ params }: PageProps) {
  ...
  const collectionJsonLd = buildCollectionJsonLd({
    title: `${brandTitle} | Internet Pascabayar DayaKlik`,
    description: `Cek dan bayar tagihan ${brandTitle} di DayaKlik dengan proses yang ringkas.`,
    path: `/internet-pascabayar/${slug}`,
